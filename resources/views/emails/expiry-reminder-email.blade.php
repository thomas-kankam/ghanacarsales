...
<head>
    ...
    <title>Car Listing Expiring Soon - OmniCarsGH</title>
                                ...
                                <tr>
                                    <td style="padding: 20px 25px;">
                                        ...
                                        <p style="font-size: 15px; color: #555; margin: 0;">
                                            Your car listing expires in 3 days. Renew now to keep it active.
                                        </p>
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    <td align="center" style="padding-bottom: 30px; justify-content: center;">
                                        <p
                                            ...
                                            ⚠️ This reminder will expire after 3 days
                                        </p>
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    <td align="center">
                                        <p style="font-size: 14px; color: #888; text-align: center; margin: 0;">
                                            If you did not request this reminder, please ignore this email or
                                            contact support.
                                        </p>
                                    </td>
                                </tr>
